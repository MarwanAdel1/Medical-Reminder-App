package com.example.medicalreminder.views.signup_screen;
                                        ...
                                        firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if(task.isSuccessful()){
                                                    Toast.makeText(Registeration.this, "Toast registered SUCCESSFULLY", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(Registeration.this, LoginScreen.class));
                                                } else{
                                                    Toast.makeText(Registeration.this, "Registration Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    }
